 ...
 * the {@link Builder}.
 */
public final class LowLatencyBandwidthMeter implements BandwidthMeter, TransferListener {
  ...
  @Nullable private static LowLatencyBandwidthMeter singletonInstance;
  ...
  public static final class Builder {
     ...
     */
    public LowLatencyBandwidthMeter build() {
      return new LowLatencyBandwidthMeter(
          context,
          initialBitrateEstimates,
  ...
  /**
   * Returns a singleton instance of a {@link LowLatencyBandwidthMeter} with default configuration.
   *
   * @param context A {@link Context}.
   * @return The singleton instance.
   */
  public static synchronized LowLatencyBandwidthMeter getSingletonInstance(Context context) {
    if (singletonInstance == null) {
      singletonInstance = new LowLatencyBandwidthMeter.Builder(context).build();
    }
  ...
  @Deprecated
  public LowLatencyBandwidthMeter() {
    this(
        /* context= */ null,
  ...
  private LowLatencyBandwidthMeter(
